#!/usr/bin/env bash
# Terminal missing 4: chay cac part con thieu 292-308.
...
PARTS=(292 293 294 295 296 297 298 299 300 301 302 303 304 305 306 307 308)
LAST_PART=${PARTS[$((${#PARTS[@]} - 1))]}

for part in "${PARTS[@]}"; do
  echo ""
  echo "========== Missing 4: Part $part | $(date '+%Y-%m-%d %H:%M:%S') =========="
...
echo ""
echo "Missing 4: Da chay xong cac part duoc giao."
