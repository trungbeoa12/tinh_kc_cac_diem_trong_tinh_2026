#!/usr/bin/env bash
# Terminal missing 3: chay cac part con thieu 275-291.
...
PARTS=(275 276 277 278 279 280 281 282 283 284 285 286 287 288 289 290 291)
LAST_PART=${PARTS[$((${#PARTS[@]} - 1))]}

for part in "${PARTS[@]}"; do
  echo ""
  echo "========== Missing 3: Part $part | $(date '+%Y-%m-%d %H:%M:%S') =========="
...
echo ""
echo "Missing 3: Da chay xong cac part duoc giao."
